...
import graphe.values.GrapheApp;
        ...
        if (lastNode != -1) {
            if (this.stateNode == 0) {
                ...
                if (this.gui.getRb_plusCulturel().isSelected()) {
                    ...
                    int result = this.app.getGraphe().plusCulturelle(
                            Canvas.getNodes().get(this.nodesSelected[0]).getName(),
                    ...
                    int result = this.app.getGraphe().plusGastronomique(
                            Canvas.getNodes().get(this.nodesSelected[0]).getName(),
                            Canvas.getNodes().get(this.nodesSelected[1]).getName());
                    if (result == 1) {
                        JOptionPane.showMessageDialog(null, Canvas.getNodes().get(this.nodesSelected[0]).getName()
                        ...
                        JOptionPane.showMessageDialog(null, Canvas.getNodes().get(this.nodesSelected[0]).getName()
                                + " n'est pas plus gastronomique que "
                                + Canvas.getNodes().get(this.nodesSelected[1]).getName());
                    } else {
                        JOptionPane.showMessageDialog(null,
                                "Les noeuds " + Canvas.getNodes().get(this.nodesSelected[0]).getName()
                    ...
                    int result = this.app.getGraphe().plusOuverte(
                            Canvas.getNodes().get(this.nodesSelected[0]).getName(),
                            Canvas.getNodes().get(this.nodesSelected[1]).getName());
                    if (result == 1) {
                        JOptionPane.showMessageDialog(null, Canvas.getNodes().get(this.nodesSelected[0]).getName()
                    ...
                    if (result != 0) {
                        JOptionPane.showMessageDialog(null,
                                "Le plus court chemin entre " + Canvas.getNodes().get(this.nodesSelected[0]).getName()
                                        + " et "
                                        + Canvas.getNodes().get(this.nodesSelected[1]).getName() + " est de "
                                        + resultString);
                    } else {
                        JOptionPane.showMessageDialog(null,
                                "Les noeuds " + Canvas.getNodes().get(this.nodesSelected[0]).getName()
                                        + " et " + Canvas.getNodes().get(this.nodesSelected[1]).getName()
                                        + " ne sont pas reliés");
                    }
                } else if (this.gui.getRb_plusCourtChemin().isSelected()) {
                    // print return of the function floydWarshallChemin in Graphe in a new
                    // messageDialog
                    ArrayList<Integer> result = this.app.getGraphe().floydWarshallChemin(this.nodesSelected[0],
                            this.nodesSelected[1]);
                    // browse result and print the path
                    if (result.size() != 0) {
                        String path = "Le plus court chemin entre "
                                + Canvas.getNodes().get(this.nodesSelected[0]).getName() + " et "
        ...
        if (lastNode != -1) {
            ...
            if (this.gui.getRb_resto1Distance().isSelected()) {
                ...
                if (result.size() == 0) {
                    ...
                    String message = "";
                    message += "La(les) ville(s) relié(s) à "
                            + Canvas.getNodes().get(this.nodesSelected[oneNodeState - 2]).getName()
                            + " est/sont : " + "\n\n";
                    for (int i = 0; i < result.size(); i++) {
                        message += "-" + result.get(i) + "\n";
                    }
                ...
                // display degres with method degre in graphe : first value is global degre,
                // second value is indegre, third value is outdegre
                int[] degres = this.app.getGraphe()
                        .degre(Canvas.getNodes().get(this.nodesSelected[oneNodeState - 2]).getName());
    ...
    public void mouseMoved(MouseEvent e) {
        ...
        for (int i = 0; i < Canvas.getNbNodes(); i++) {
            if (x >= Canvas.getNodes().get(i).getPosX() - 50 && x <= Canvas.getNodes().get(i).getPosX() + 50
                ...
                if (Canvas.getNodes().get(i).isSelected()
                        && (this.nodesSelected[0] == -1 || i != this.nodesSelected[0])) {
