...
public class Matrice {
    ...
    /**
     * 
     * fonction du calcul de produit vectoriel à une position donnée de la matrice
     * résultante.
     * 
    ...
    public int multAdd(Matrice mat, int ligne, int col) {
        ...
        for (int i = 0; i < this.matrice[ligne].length; i++) {
            result += (this.matrice[ligne][i] * mat.matrice[i][col]);// on fait la somme des produits de l'élément i de
                                                                     // la ligne de la matrice multipliée par l'élément
                                                                     // i de la colone de la matrice multiplicatrice.
        }
        return result;
    }
