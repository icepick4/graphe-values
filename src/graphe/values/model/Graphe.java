...
public class Graphe {
     ...
     */
    public Graphe(Matrice matriceBool, MatriceDouble matriceValuations, MatriceString matriceLiens,
     ...
     * 
     * @return Liste des noms de toutes les villes dans le graphe
     *         (ArrayList<String>)
     */
     ...
     * 
     * @return Liste des noms de touts les loisirs dans le graphe
     *         (ArrayList<String>)
     */
     ...
     * 
     * @return Liste des noms de touts les restaurants dans le graphe
     *         (ArrayList<String>)
     */
    ...
    /**
     * Méthode qui applique l'algoritjme de Floyd-Warshall pour trouver les plus
     * courts chemins entre tous les noeuds
     * 
     * @return {@link MatriceDouble} des plus courts chemins entre tous les noeuds
     *         (valuations)
     */
    ...
    /**
     * Méthode qui applique l'algoritjme de Floyd-Warshall pour trouver les
     * prédécesseurs entre tous les noeuds
     * 
     ...
     * 
     * @param sommet Nom du sommet de départ
     * @return tous les sommets qui sont des restaurants et qui sont voisins de
     *         sommet
     */
     ...
     * 
     * @param sommet Nom du sommet de départ
     * @return tous les sommets qui sont des Lieux de loisirs et qui sont voisins de
     *         sommet
     */
     ...
     *         degre du sommet, respectivement le degré simple, le demi-degré
     *         extérieur puis demi-degré intérieur
     ...
     * @return {@code true} si sommet1 est un predecesseur de sommet2, sinon
     *         {@code false}
     */
     ...
     * @param sommet1 sommet auquel on récupère les successeurs
     * @param sommet2 sommet auquel on récupère les successeurs
     * @return {@code true} si sommet1 est un successeur de sommet2, sinon
     *         {@code false}
     */
    ...
    public ArrayList<Integer> clique(int sommet) {
        ...
        for (int j = sommet + 1; j < this.ordre(); j++) {
            for (int i = 0; i < clique.size(); i++) {
                if (this.verifSuccesseur(clique.get(i), j) && this.verifSuccesseur(j, clique.get(i))
                        && !(clique.contains(j))) {
                    valid++;
                }
            }
     ...
     * @param sommet1
     * @param sommet2
     * @return {@code true} si le sommet {@code sommet1} est relié au sommet
     *         {@code sommet2} sinon {@code false}
     */
     ...
     * @param sommet1
     * @param sommet2
     * @return la longueur du chemin le plus court entre deux sommets, 0 s'il y en a
     *         pas.
     */
    ...
    /**
     * Méthode qui permet de savoir s'il existe un chemin d'une certaine distance
     * entre deux sommets.
     * 
     * @param longueur
     * @param sommet1
     * @param sommet2
     * @return {@code true} s'il existe un chemin d'une certaine distance entre deux
     *         sommets, {@code false} sinon.
     */
